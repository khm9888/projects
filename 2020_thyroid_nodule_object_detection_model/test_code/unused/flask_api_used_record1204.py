...
def test():
    ...
    if request.method == 'POST':
        ...
        for file_location,img_file in img_files.items():
            ...
            # print("img_file")
            # print("1", type(img_file))
            # print("1", img_file)
            # print(" ")
            # # print(img_file.read())
            # img_file = img_file.read()
            # print("2", type(img_file))
            # print(" ")
            # #img_file = np.array(img_file,dtype =np.float64)
            # img_file = np.array(img_file)
            # print(3,type(img_file))
            # # img_file=list(np.array("f",img_file))
            # # print(type(img_file))

            print("img_filepath.shape")
