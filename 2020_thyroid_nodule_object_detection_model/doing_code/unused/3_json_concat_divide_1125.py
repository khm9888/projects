...
json1 = "from_db_1118_1125.json"
json2 = "train.json"
json3 = "test_1125.json"
...
with open(path+json1,"r") as file1 :
    data_db= json.load(file1)



def divide(origin_data,random_state=random_state):
    ...
    print("type(count_dict[1])")
    print(type(count_dict[1]))
    print(len(count_dict[1]))
    print(len(count_dict[0]))
...
with open(path+json2,"r") as file2 :
    train_db= json.load(file2)

train_encrypt_ids =set()
data_encrypt_ids =set()

for image in train_db["images"]:
    train_encrypt_ids.add(image["encrypt_id"])

for image in data_db["images"]:
    data_encrypt_ids.add(image["encrypt_id"])

print("len(train_encrypt_ids)")
print(len(train_encrypt_ids))

print("len(data_encrypt_ids)")
print(len(data_encrypt_ids))

intersect_ids = train_encrypt_ids&data_encrypt_ids
...
for data in data_db["images"]:
    if data["encrypt_id"] in intersect_ids:
        pass
    elif data["encrypt_id"] in filter_encrypt_id:
        pass
    elif data["encrypt_id"] in used_ids:
        pass
    else:
        used_ids.append(data["encrypt_id"])
