...
def module_1(image,threshold):
    ...
    print("maker_id")
    print(maker_id)
    if file_name not in save and maker_id !=0:
        print("module1")
...
for threshold in thresholds:
    for i,image in enumerate(image_data):
        # print(f"--{i}--")
        preprocess_img_path=f"/mnt/sdb/AI/work/preprocess/threshold_{threshold}/"
        print(i)
        for j in range(10):
            createFolder(preprocess_img_path+f"{j}")
        module_1(image,threshold)
