...
해당 프로젝트는 랜덤으로 화음을 만들어주는 코드입니다.
1. 각각의 화음(chord)에 따른 음계(melody)를 부여하고,
2. 사용자가 입력 또는 랜덤으로 선택된 8개의 음계에 따라 화음이 선택됩니다.(1,8번째 화음은 C코드로 고정합니다.)
3. 각 화음에 따라 mid(미디파일)로 출력합니다.
