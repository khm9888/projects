...
for size in np.arange(0.90,0.93,0.01):
    ...
    x_train,x_test,y_train,y_test = train_test_split(x,y,train_size=size,random_state=66)
    learning_rate=0.1
    model = MultiOutputRegressor(LGBMRegressor(n_estimators=1000, learning_rate=learning_rate, max_depth=-1, colsample_bytree=0.8, num_leaves=31))
