...
## 데이터 불러오기
train = pd.read_csv('./dacon/comp1_bio/csv/train.csv', sep=',', index_col = 0, header = 0)
test = pd.read_csv('./dacon/comp1_bio/csv/test.csv', sep=',', index_col = 0, header = 0)
...
train_dst = train.filter(regex='_dst$',axis=1).interpolate(limit_direction='both',axis=1).values / train_damp# 선형보간법
