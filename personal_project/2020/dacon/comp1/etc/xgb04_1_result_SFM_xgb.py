...
for size in np.arange(0.91,0.911,0.01):
    ...
    xgb_0 = XGBRegressor(n_estimators=100,learning_rate=0.2,max_depth= 7)
    xgb_1 = XGBRegressor(n_estimators=100,learning_rate=0.1,max_depth= 4)
    xgb_2 = XGBRegressor(n_estimators=100,learning_rate=0.12,colsample_bytree=0.8,colsample_bylevel=0.4,max_depth=3)
    xgb_3 = XGBRegressor(n_estimators=100,learning_rate=0.13,colsample_bytree=0.8,colsample_bylevel=0.9,max_depth=4)
    ...
    selection_xgb_0 = XGBRegressor(n_estimators=500, learning_rate=0.2,max_depth= 7)
    selection_xgb_1 = XGBRegressor(n_estimators=500, learning_rate=0.1,max_depth= 4)
    selection_xgb_2 = XGBRegressor(n_estimators=500, learning_rate=0.12,colsample_bytree=0.8,colsample_bylevel=0.4,max_depth=3)
    selection_xgb_3 = XGBRegressor(n_estimators=500, learning_rate=0.13,colsample_bytree=0.8,colsample_bylevel=0.9,max_depth=4)
