...
def train(model,X,Y):
    MODEL_SAVE_FOLDER_PATH = './data/dacon/comp2/model/'
...
# submit.to_csv(f'./data/dacon/comp2/{name}_{str(score)[:5]}_.csv', index = False)
submit.to_csv(f'./data/dacon/comp2/{name}__.csv', index = False)