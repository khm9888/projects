...
dtypes.to_csv("./data/dacon/comp3/preprocess/dtypes.csv")
df_num.to_csv("./data/dacon/comp3/preprocess/df_num.csv")

print("start_read")
data = pd.read_csv("./data/dacon/comp3/preprocess/data.csv")
df = pd.read_csv("./data/dacon/comp3/preprocess/df.csv")
dtypes = pd.read_csv("./data/dacon/comp3/preprocess/dtypes.csv")
df_num = pd.read_csv("./data/dacon/comp3/preprocess/df_num.csv")
print("end_read")
...
submission.to_csv(f"./data/dacon/comp3/{name}.csv", encoding='utf-8-sig')
submission.head()
