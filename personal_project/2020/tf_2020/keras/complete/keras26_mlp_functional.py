...
y=np.array([range(1,101),range(711,811),range(100)])
...
input1 = Input(shape=(3,))#입력값
dense1= Dense(5,activation="relu")(input1)
dense2= Dense(3)(dense1)
dense3= Dense(4)(dense2)
output1=Dense(3)(dense3)#출력값
...
model.fit(x_train,y_train,epochs=100,validation_split=0.25,callbacks=[early_stopping])
