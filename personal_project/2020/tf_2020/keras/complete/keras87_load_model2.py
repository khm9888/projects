...
model.add(Dense(10,name="dense_x"))
model.add(Dense(10,name="dense_x2"))
model.add(Dense(10,name="dense_x3"))
...
# hist=model.fit(x_train,y_train,epochs=5,batch_size=200,validation_split=0.1)
