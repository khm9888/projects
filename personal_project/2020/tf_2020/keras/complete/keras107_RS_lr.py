...
def build_model(drop=0.5, optimizer=adam, lr=0.1):
    ...
    model.compile(optimizer=optimizer(lr),metrics=['acc'],loss='categorical_crossentropy')
...
def create_hyperparameters():
    ...
    return {'batch_size' : batchs,'optimizer' : optimizer, 'drop': dropout , "lr":lr}
