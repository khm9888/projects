...
# def build_model_cnn(optimizer=adam,node=32,loss="categorical_crossentropy"):
    ...
    conv=Conv2D(node*2,(2,2),padding="same",activation="relu")(input1)
    ...
    conv=Conv2D(node*2,(2,2),padding="same",activation="relu")(max1)
    conv=Conv2D(node*2,(2,2),padding="same",activation="relu")(conv)
    max1=MaxPool2D(pool_size=3)(conv)
...
'''
d:\Study\keras\keras114_dropout.py
loss:1.74704844121933
acc:0.7246000170707703'''