...
xgb = XGBRegressor (max_depth=max_depth, n_estimators=n_estimators, learning_rate=learning_rate, colsample_bytree=colsample_bytree,
...
------------------------------
__file__
d:\Study\ml\m23_1_xgb_boston_gridsearch.py
...
------------------------------
model.best_params_
{'colsample_bylevel': 0.7, 'colsample_bytree': 0.7, 'learning_rate': 0.02, 'max_depth': 6, 'n_estimators': 300}
