...
x_test_scaled=x_test_scaled.reshape(x_test_scaled.shape[0],5,5)
...
model.fit([x_train_scaled,x2_train_scaled],y_train,epochs=100,batch_size=1,validation_split=0.1,callbacks=[early])
