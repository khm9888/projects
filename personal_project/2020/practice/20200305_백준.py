...
# 셋째 줄에는 하덕버거의 가격이 주어진다. 넷째 줄에는 콜라의 가격, 다섯째 줄에는 사이다의 가격이 주어진다. 모든 가격은 100원 이상, 2000원 이하이다.
...
min_beverage=min(beverage1,beverage2)

value=min_beverage+min_burger-50
print(value)