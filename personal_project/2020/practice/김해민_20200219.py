...
class Male_Info:#남성 정보 입력 클래스
	...
	def save(self): #정보가 온전히 입력됐다면 딕셔너리(해쉬)에 추가하고 출력한다.
		information=dict()
...
class Female_Info:#여성 정보 입력 클래스
...
class CoupleManager:
	...
	def age_gap(self):#나이 차를 출력하는 함수
		this_year=2020
	...
	def distant(self):#거리 차를 출력하는 함수
	...
	def count_hobby(self):#취미 개수 카운트 함수
		count=0
