...
name="식생활"
detail_address="D:\private\lecture\python_prac\practice\김연희\\"
...
# with open(f"{detail_address}{name}_urls.txt",'w',encoding='utf-8') as file:
#     for url in urls:
#         file.write(url)



with open(f"{detail_address}{name}_urls.txt",'r',encoding='utf-8') as file:
    lines=file.readlines()
    for i,line in enumerate(lines):
        ...
        with open(f"{detail_address}{name}_results.txt",'a',encoding='utf-8') as file:
