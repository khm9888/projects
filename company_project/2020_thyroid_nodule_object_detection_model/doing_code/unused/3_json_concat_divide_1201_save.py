...
def divide(origin_data,random_state=random_state):
    ...
    number = input("6개의 번호(0~5)중 원하는 건?")
...
count_dict_1 = divide(origin_data,random_state) #통틀어 하루만 등장한 환자 암호화키
test_n=count_dict_1[0]
train_n,val_n = train_test_split(count_dict_1[1],train_size=0.9,random_state=random_state) #10으로 나눴었음 #15프로 처참 #11
