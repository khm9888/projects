...
from mmcv.cnn import (constant_init, kaiming_init, build_conv_layer,
                      build_norm_layer)
from mmcv.runner import load_checkpoint
from torch.nn.modules.batchnorm import _BatchNorm

from mmdet.ops import ContextBlock, GeneralizedAttention
        ...
        if isinstance(pretrained, str):
            ...
            for m in self.modules():
                if isinstance(m, nn.Conv2d):
                    ...
                    constant_init(m, 1)
            for m in self.modules():
                if isinstance(m, Res2Net) or isinstance(m, ResNet):
