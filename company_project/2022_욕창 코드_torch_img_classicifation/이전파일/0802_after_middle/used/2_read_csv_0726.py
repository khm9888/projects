...
data_2 = pd.read_csv("/home/ubuntu/con/code/BiT/data/labels/train.csv")
print(data_2)

val.to_csv("/home/ubuntu/con/code/BiT/data/labels/val.csv",index=0)
data_2 = pd.read_csv("/home/ubuntu/con/code/BiT/data/labels/val.csv")
print(data_2)

test.to_csv("/home/ubuntu/con/code/BiT/data/labels/test.csv",index=0)
data_2 = pd.read_csv("/home/ubuntu/con/code/BiT/data/labels/test.csv")
print(data_2)
