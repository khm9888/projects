...
def mktrainval(args, logger,i):
    ...
    train_set = cus_dataset.CustomDataset(args.datadir, args.imagedir, set_name=f'train_{i}', cls_num=7, transform=train_tx)
    valid_set = cus_dataset.CustomDataset(args.datadir, args.imagedir, set_name=f'val_{i}', cls_num=7, transform=val_tx)     
