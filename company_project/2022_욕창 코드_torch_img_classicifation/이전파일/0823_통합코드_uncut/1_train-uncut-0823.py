...
def mktrainval(args, logger):
    ...
    train_set = cus_dataset.CustomDataset(args.datadir, args.imagedir, set_name=f'train_{args.data_num}', cls_num=6, transform=train_tx)
    valid_set = cus_dataset.CustomDataset(args.datadir, args.imagedir, set_name=f'val_{args.data_num}', cls_num=6, transform=val_tx)     
