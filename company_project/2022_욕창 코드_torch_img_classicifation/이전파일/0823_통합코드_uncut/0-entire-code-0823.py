...
if "0-0" in choice:
    ...
    data_0707 = pd.read_excel("/home/ubuntu/Data/upload_20210707.xlsx")#origin xlsx file
    data_keys=list(data_0707.keys())

    data_0812 = pd.read_excel("/home/ubuntu/Data/upload_20210812.xlsx")#origin xlsx file
    data_keys=list(data_0812.keys())

    # print(data_0707)
    # print(data_0812)

    data_df = pd.concat([data_0707,data_0812])

    data_df.to_csv("/home/ubuntu/Data/upload_uncut.csv",index=0)

    data_df_a = pd.read_csv("/home/ubuntu/Data/upload_uncut.csv")#origin xlsx file
    print(data_df_a)
###########################
# 0-0 완료
###########################
