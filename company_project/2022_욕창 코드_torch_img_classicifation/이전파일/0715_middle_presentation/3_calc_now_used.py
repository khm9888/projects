...
valid_set = cus_dataset.CustomDataset(args.datadir, args.imagedir, set_name='val', cls_num=6, transform=val_tx)
...
print("df")
print(df)
df.to_csv("/home/ubuntu/con/code/BiT/test.csv")

df2=pd.read_csv("/home/ubuntu/con/code/BiT/test.csv")
print("df2")
print(df2)