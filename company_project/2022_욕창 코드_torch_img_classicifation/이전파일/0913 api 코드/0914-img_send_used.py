...
for i,file in enumerate(filelist[:-1]):
    ...
    # body_param[file] = {"image":open(img_path+file,"rb"),"coordinate":[1,2,3,4]}
    body_param[file] = open(img_path+file,"rb")
...
print("--request--")
# req= requests.post('http://0.0.0.0:8556/', files=body_param) # 68:7879
req= requests.post('http://127.0.0.1:8557/', files=body_param) # 68:7879
print("--req---")
print(req)
print("--req---")
