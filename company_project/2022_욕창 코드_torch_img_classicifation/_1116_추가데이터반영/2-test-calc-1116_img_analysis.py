...
if 1 in choice:
    ...
    for x,y in tqdm(test_loader):
        ...
        model = torch.load(f"/home/ubuntu/con/code/BiT/runs/burn_R152x2_add1/best_{args.data_num}.pth")
        pred_value = model(x)
        # print("pred_value")
        # print(pred_value)
    ...
    print("df")
    print(df)
    df.to_csv(f"/home/ubuntu/con/code/BiT/data/labels/result_{args.data_num}.csv",index=0)
...
if 2 in choice:
    ...
    df2=pd.read_csv(f"/home/ubuntu/con/code/BiT/data/labels/result_{args.data_num}.csv")
    print("df2")
    print(df2)
...
if 3 in choice:
    ...
    df_result=pd.read_csv(f"/home/ubuntu/con/code/BiT/data/labels/result_{args.data_num}.csv")
    df_test=pd.read_csv(f"/home/ubuntu/con/code/BiT/data/labels/test_{args.data_num}.csv")
    ...
    save_path = f"/home/ubuntu/con/img_{today[2:]}/"
