...
def main():
    # var init 
    root_dir = f'{path_burn_image}/csv_data/labels_2del/'
    ...
    data_path = f'{path_burn_image}/after_crop_2del/test/' # test_210914_crop/'
    # data_path = '../data/data/con_test_211112/image_crop/a/' # test_210914_crop/'
    path_only = True # False
    dest_dir = f'{path_burn_image}/result/'
    ...
    df_result.to_csv(f"{path_burn_image}/result_bit.csv",index=0)
